...
namespace game
{
	...
	class CircleManager : public core::ComponentManager<
			CircleBody, static_cast<core::EntityMask>(core::ComponentType::CIRCLE_BODY2D)>
	{
	public:
	...
	public:
		...
		bool BodyIntersect(CircleBody body1, CircleBody body2) const;
		void ResolveBodyIntersect(CircleBody& body1, CircleBody& body2) const;
		static core::Vec2f ContactPoint(const CircleBody& body1, const CircleBody& body2);
		static core::Vec2f RelocateCenter(const CircleBody& body, const core::Vec2f& v);
		float CalculateDistance(CircleBody body1, CircleBody body2) const;
